...
Hi, I'm **Junghoon Lim**, Director of **FLOW: AX Design Lab**. After releasing the Windows-only [FLOW ZoomIt](https://github.com/Demian-Yim/flow-zoomit), several Korean trainers asked for a Mac equivalent. Microsoft never ported ZoomIt to macOS, so I'm forking [@07JP27](https://github.com/07JP27)'s [ZoomacIt](https://github.com/07JP27/ZoomacIt) under GPL-3.0 with FLOW Korean defaults.
